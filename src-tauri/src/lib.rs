...
fn specta_builder() -> tauri_specta::Builder<tauri::Wry> {
    tauri_specta::Builder::<tauri::Wry>::new()
        .commands(tauri_specta::collect_commands![
            ...
            log_archive_cleanup,
            log_archive_clear,
            // processing (app-only часть — мигрирована; sendLog/setStatusBar/path_exists плагинные, оставлены)
            abort_processing,
            move_to_errors,
            send_node_start,
            send_node_done,
...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            shellOpenPath,
            openNodeWindow,
            // processing camel: abortProcessing/processItem/sendNode*/sendProcessComplete удалены
            // (мигрированы на specta). setStatusBar/sendLog ОСТАВЛЕНЫ — их зовут плагины.
            setStatusBar,
            sendLog,
