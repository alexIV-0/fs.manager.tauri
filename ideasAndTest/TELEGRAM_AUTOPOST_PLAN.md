...
плагин собирается. **Не хватает live-теста** с реальным ботом/каналом (как у VK —
ручная проверка флоу). Отдельный плагин по принципам VK-автопостинга (`autoPostVK`).
